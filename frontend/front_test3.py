...
with col_viz:
    if st.session_state.latest_response:
        ...
        with c2: 
            ...
            if backend_viz not in ["table", "bar", "line", "pie", "number"]: backend_viz = "table"
            if st.session_state.current_viz_type is None: st.session_state.current_viz_type = backend_viz
